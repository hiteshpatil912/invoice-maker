...
const ClientSelectionModal = ({
  ...
  // Check if clients.data is defined and is an array
  const hasClientData = Array.isArray(clients.data) && clients.data.length > 0;
    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-10">
      <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-3xl w-full">
        <div className="p-6">
          ...
          {hasClientData && clients.data.length === 0 && (
